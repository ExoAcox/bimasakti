...
const PanelDetail = () => {
    ...
    if (!data) return null
    const parentPlanet = (data.parent ? getObjectById(data.parent) : null) as Planet
    return <div className="flex flex-col fixed top-4 right-4 bottom-4 text-sm text-gray-300 bg-black/50 min-w-sm max-w-sm rounded-md pb-6 pt-4 px-7 z-50 backdrop-blur-sm max-h-dvh h-fit">
        <div>
            ...
            <div className="mt-4 text-sm text-gray-300 leading-relaxed border-t border-white/25 pt-4">
                ...
                {data.type !== "star" ? <div className="flex justify-between items-center">
                    ...
                    <span>{data.orbit_duration.toLocaleString()} {t("ui.days")}</span>
                </div> : null}
            ...
            {
                data.type === "planet" && data.satellites && data.satellites.length ? <div className="mt-4 mb-2 leading-relaxed border-t border-white/25 pt-4">
        ...
        <div className="flex-1 overflow-auto">
            ...
            {
                data.type === "planet" && data.satellites && data.satellites.length ? <div className="flex flex-col gap-4">
